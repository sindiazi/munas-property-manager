package com.example.rentalmanager.payment.infrastructure.gateway.mpesa;

import com.example.rentalmanager.payment.application.port.output.GatewayInitiationResult;
import com.example.rentalmanager.payment.application.port.output.GatewayPaymentRequest;
import com.example.rentalmanager.payment.application.port.output.GatewayPaymentStatus;
import com.example.rentalmanager.payment.application.port.output.GatewayStatusResult;
...
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.dto.DarajaQueryRequest;
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.dto.DarajaQueryResponse;
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.dto.DarajaStkPushRequest;
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.dto.DarajaStkPushResponse;
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.dto.DarajaTokenResponse;
                    ...
                    return mpesaWebClient.post()
                            ...
                            .map(resp -> {
                                ...
                                return new GatewayStatusResult(
                                        resp.checkoutRequestId(), status,
                                        resp.resultDesc(), null, null, null);
                            });
                });
    }
