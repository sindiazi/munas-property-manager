package com.example.rentalmanager.payment.infrastructure;
...
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.DarajaTokenCache;
import com.example.rentalmanager.payment.infrastructure.gateway.mpesa.MpesaDarajaAdapter;
...
class MpesaDarajaAdapterTest {
    ...
    void initiate_amount_isRoundedToWholeKES_inSerializedBody() throws Exception {
        ...
        var req = new GatewayPaymentRequest(UUID.randomUUID(), UUID.randomUUID(),
                "254708374149", new BigDecimal("1500.75"), "KES", "LSE-ABCD1234");
    ...
    private GatewayPaymentRequest testRequest() {
        return new GatewayPaymentRequest(UUID.randomUUID(), UUID.randomUUID(),
                "254708374149", new BigDecimal("5000"), "KES", "LSE-ABCD1234");
    }
